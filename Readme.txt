...
ÎÄ¼þ£º
          Algorithms.py: compared algorithms, including£º
	-kmeans():   K-means
	...
	-SCA_clustering():   SCA
          ...
          SCA2.py: the proposed SCA2£¬including the following function£º
	...
	-PSOClusteringAlgorithm(): the main framework of SCA2
          ...
          PublicFunctions.py: public operation£¬including£º
